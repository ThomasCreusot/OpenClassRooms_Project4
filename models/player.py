...
class Player:
    ...
    def players_initialization_from_json_dictionnary(cls):
        ...
        # for player_attributes in json.load(open("players_json.json")): #il faut ouvrir la bdd "db.json" ; on veut
        # acceder à la table appelée players_table en python
    ...
    def load_players_from_tinydb_at_python_format(cls):
        ...
        for serialized_player in serialized_players:
            ...
            # int() dans le modele car on importe des données, ce n'est pas l'utilisateur qui communique l'information
