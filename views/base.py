...
class View:
    ...
    def menu(self):
        ...
        menu_choice = input(
            ...
            "If you want to see all players, please press '4'" "\n"
            "If you want to play a tournament, please press '5'" "\n"
            "If you want to update a player rank, please press '6'" "\n"
    ...
    def wrong_player_score(self):
        """Advertissement about the score which is not in the list SCORES"""

        print("Advertissement: the score is not an allowed one ({0}), please try again".format(SCORES))
