...
class View:
    ...
    def menu(self):
        ...
        menu_choice = input(
            ...
            "If you want to see all players or all players from a tournament, classified by alphabetical or rank"
            "(classification) order, please press '6'" "\n"
    ...
    def information_for_tournament_initialization(self):
        ...
        return tournament_name, tournament_localisation, tournament_date_of_beginning, tournament_date_of_ending,\
    ...
    def tournament_player_results_display(self, player_name, player_total_score_at_tournament_scale, player_rank):
        ...
        # print("Player {0} got a total score of {1} during this tournament and its rank is {2}".format(player_name,
    ...
    def information_for_updating_player_rank(self):
        ...
        concerned_player_index = input("For which player do you want to update the rank ? Please write its index")
        new_rank = input("What is the updated rank value, please ? ")
    ...
    def information_for_displaying_tournament_players(self):
        ...
        information_tournament = input("For which tournament do you want to display players ? Please write the " "\n"
    ...
    def information_for_displaying_tournament_rounds_or_matches(self):
        ...
        information_tournament = input("For which tournament do you want to display rounds or matches ? Please " "\n"
    ...
    def display_match_result(self, player_1_first_name, player_1_family_name, player_2_first_name,
        ...
        print()
        print("Match results : {0} {1} versus {2} {3}".format(player_1_first_name, player_1_family_name,
              player_2_first_name, player_2_family_name))
        print("    {0} {1} : {2}".format(player_1_first_name, player_1_family_name, player_1_score))
